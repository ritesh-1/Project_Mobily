...
<section id="cart" class="py-3 mb-5">
    <div class="container-fluid w-75">
        <h5 class="font-archivo font-size-20">Shopping Cart</h5>
        ...
        <div class="row">
                ...
                <div class="row border-top py-3 mt-3">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="d-flex">
                            ...
                            <a href="#" class="px-2 font-archivo font-size-14">20,534 ratings</a>
                        </div>
                        <!-- !Product rating -->

                        <!-- Product qty -->
                        <div class="qty d-flex pt-2">
                            <div class="d-flex font-archivo w25">
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    <h6 class="font-size-12 font-archivo text-success py-3"><i class="fas fa-check"></i>Your order is eligible for FREE Delivery</h6>
